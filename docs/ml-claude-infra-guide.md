...
> mv ml-claude-infra \~/dev/ml-claude-infra
...
> cd \$PROJECT && git init
>
> cp -r \~/dev/ml-claude-infra/.claude/ .claude/
>
> cp \~/dev/ml-claude-infra/templates/pyproject.toml .
>
> cp \~/dev/ml-claude-infra/templates/.env.example .
>
> cp \~/dev/ml-claude-infra/templates/Makefile .
>
> cp \~/dev/ml-claude-infra/templates/Dockerfile .
>
> cp \~/dev/ml-claude-infra/templates/docker-compose.yml .
>
> cp \~/dev/ml-claude-infra/templates/design-doc.md .
>
> cp \~/dev/ml-claude-infra/templates/status.md dev/
>
> cp -r \~/dev/ml-claude-infra/templates/github/ .github/
...
ml-claude-infra v0.5.0 · Внутренняя документация
