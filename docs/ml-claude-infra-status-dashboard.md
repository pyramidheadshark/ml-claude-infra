...
> синхронизация .claude/ из \~/dev/ml-claude-infra/ во все проекты.
...
> Мы продолжаем работу над ml-claude-infra --- персональной
> инфраструктурой Claude Code для ML-инженера.
>
> Репозиторий: \~/dev/ml-claude-infra/ \| Текущая версия: v0.5.0
>
...
ml-claude-infra v0.5.0 · Project Status Dashboard · 2026-03-02
